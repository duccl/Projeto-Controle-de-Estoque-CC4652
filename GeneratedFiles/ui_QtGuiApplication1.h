...
public:
    ...
    void setupUi(QMainWindow *QtGuiApplication1)
    {
        ...
        formLayoutWidget->setGeometry(QRect(30, 50, 781, 211));
        ...
        formLayout->setWidget(4, QFormLayout::FieldRole, botaoLogin);
        ...
        formLayout->setWidget(6, QFormLayout::FieldRole, label_4);
